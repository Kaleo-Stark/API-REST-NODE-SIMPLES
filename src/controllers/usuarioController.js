...
exports.post = (req, res, next) => { // .......... Exporta a função 'post', normalmente responsavel por adicional algo.
	let dadosUsuario = req.body; // ........... Recebe os dados a serem salvos;

	res.status(201).send(`Rota POST! Nome usuário: ${dadosUsuario.nome}`); // ... Retorna o sucesso do salvamento;
};

exports.put = (req, res, next) => { // ... Exporta a função 'put', normalmente responsavel por alterar algo.
	let dadosUsuario = req.body; // ............................ Recebe os dados a serem alterados.

	res.status(201).send(`Rota PUT com ID e Nome para ser alterado! --> ID:${dadosUsuario.id}, Nome: ${dadosUsuario.nome}`); /* ... Retorna o sucesso do salvamento. */
};

exports.delete = (req, res, next) => { // ........................... Exporta a função 'delete', normalmente responsavel por deletar algo.
	let id = req.body.id; // .................................. Recebe o id do dado a ser deletado.
...
exports.getById = (req, res, next) => { // ................... Exporta a função 'get' com aceitação de parametros , normalmente responsavel por solicitar algo passando algum parametro.
	let id = req.body.id; // ........................... Recebe o id para buscar um dado expecifico.
